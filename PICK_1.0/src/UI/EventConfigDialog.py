...
class EventConfigDialog(object):
    def setUpDialogUI(self, QWidget):
        ...
        eventDescriptionEditText.setText("sdfsdddfsfdffhakjsdfhwiekrfhasfhsfa sdfjhldksjflskadf jlsdfjsal dfasjd flksdj flasj flasdjf lasdjf lasdfjk alsdfkj alskdfja slfijiao f;of esaijs fole jaoisfj o;ifjoae jfaosf jhefij sa;olifj a;seofi ;aslefj asiefj e")
        ...
        rootDirectoryEditText.setText("/C/User/Documents/EventName/Root")
